...
describe('Photo e2e test', () => {
  ...
  describe('new Photo page', () => {
    ...
    it('should create an instance of Photo', () => {
      ...
      //cy.get(`[data-cy="taken"]`).type('2022-03-06T11:26').should('have.value', '2022-03-06T11:26');

      //cy.get(`[data-cy="uploaded"]`).type('2022-03-06T10:02').should('have.value', '2022-03-06T10:02');
