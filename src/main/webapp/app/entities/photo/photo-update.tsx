...
export const PhotoUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const metadata = (
    <div>
      <ValidatedField label={translate('owlpixApp.photo.height')} id="photo-height" name="height" data-cy="height" type="text" />
      <ValidatedField label={translate('owlpixApp.photo.width')} id="photo-width" name="width" data-cy="width" type="text" />
      <ValidatedField
        label={translate('owlpixApp.photo.taken')}
        id="photo-taken"
        name="taken"
        data-cy="taken"
        type="datetime-local"
      ...
      />
      <ValidatedField
        label={translate('owlpixApp.photo.uploaded')}
        id="photo-uploaded"
        name="uploaded"
        data-cy="uploaded"
        type="datetime-local"
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="owlpixApp.photo.home.createOrEditLabel" data-cy="PhotoCreateUpdateHeading">
            <Translate contentKey="owlpixApp.photo.home.createOrEditLabel">Create or edit a Photo</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('owlpixApp.photo.title')}
                id="photo-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('owlpixApp.photo.description')}
              ...
              />
              <ValidatedBlobField
                label={translate('owlpixApp.photo.image')}
                id="photo-image"
                name="image"
                data-cy="image"
                isImage
              ...
              />
              {metadataRows}
              <ValidatedField id="photo-album" name="album" data-cy="album" label={translate('owlpixApp.photo.album')} type="select">
                <option value="" key="0" />
                {albums
              ...
              <ValidatedField label={translate('owlpixApp.photo.tag')} id="photo-tag" data-cy="tag" type="select" multiple name="tags">
                <option value="" key="0" />
                {tags
