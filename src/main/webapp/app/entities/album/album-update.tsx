  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="owlpixApp.album.home.createOrEditLabel" data-cy="AlbumCreateUpdateHeading">
            <Translate contentKey="owlpixApp.album.home.createOrEditLabel">Create or edit a Album</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('owlpixApp.album.title')}
                id="album-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('owlpixApp.album.description')}
              ...
              />
              <ValidatedField
                label={translate('owlpixApp.album.created')}
                id="album-created"
                name="created"
                data-cy="created"
                type="datetime-local"
              ...
              />
              <ValidatedField id="album-user" name="user" data-cy="user" label={translate('owlpixApp.album.user')} type="select">
                <option value="" key="0" />
                {users
